                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-10 h-10 bg-saffron-100 rounded-full overflow-hidden flex items-center justify-center shrink-0">
                          {p.profilePhoto ? <img src={`https://zutsav-production.up.railway.app/${p.profilePhoto}`} className="w-full h-full object-cover" alt="" /> : <User size={16} className="text-saffron-500" />}
                        </div>
              ...
              if (!hasBank && !hasUpi) {
                return (
                  <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4">
                    <p className="text-sm font-bold text-red-700 mb-1">âš  Cannot Process Payout</p>
              ...
              <div key={p._id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="p-5 flex flex-col sm:flex-row items-start gap-4">
                  <div className="w-14 h-14 bg-saffron-100 rounded-xl overflow-hidden shrink-0 flex items-center justify-center">
                    {p.profilePhoto
                      ? <img src={`https://zutsav-production.up.railway.app/${p.profilePhoto}`} className="w-full h-full object-cover" alt="" />
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      {[
                        ...
                        <div key={label} className="bg-white rounded-xl border border-gray-100 p-3">
                          ...
                          {url ? (
                            <a href={`https://zutsav-production.up.railway.app/${url}`} target="_blank" rel="noopener noreferrer"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
          {categories.map((c) => (
            <div key={c._id} className="bg-white rounded-xl p-4 border border-saffron-100 text-center">
              {c.image && <img src={`https://zutsav-production.up.railway.app/${c.image}`} className="w-12 h-12 mx-auto rounded-full object-cover mb-2" alt="" />}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {kits.map((k) => (
            <div key={k._id} className="bg-white rounded-2xl border border-gray-100 p-4">
              {k.image && <img src={`https://zutsav-production.up.railway.app/${k.image}`} alt="" className="w-full h-32 object-cover rounded-xl mb-3" />}
